...
export const IdentifiedEntitySchema = z
  .object({
    canonical_name: z
      .string()
      .min(1)
      .describe(
        "Best-known canonical title for the matched movie or TV series.",
      ),
    type: z
    ...
    confidence: z
      ...
      .describe(
        "Confidence that the user description maps to the canonical title.",
      ),
  })
  .describe(
